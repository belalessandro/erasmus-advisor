...
public class TestClass{
	...
	public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
		...
		try {
			...
			List<TeachingSearchRow> list = null;
			list = InsegnamentoDatabase.searchInsegnamento(con, null, null, null, null, null);
			//ArgomentoTesiDatabase.getArgomentoTesiSearch(con, "1");
			System.out.println(list.get(0).getArg().getNome());
			System.out.println(list.get(1).getArg().getNome());
			System.out.println(list.get(2).getArg().getNome());
			// insert test
