...
INSERT INTO Universita VALUES 
	...
	('Ecole normale sup√©rieure','www.ens.fr', 28, TRUE, 'Paris', 'France'),
	...
	('UniversitÈ Pierre et Marie Curie, Paris 6- Main Site','http://www.upmc.fr/en/', 45, TRUE, 'Paris', 'France'),
...
INSERT INTO Flusso (Id, Destinazione, RespFlusso, PostiDisponibili, Attivo, DataUltimaModifica, Durata, Dettagli) VALUES 
	('FRA001', 'Ecole normale sup√©rieure', 'pilu', 10, TRUE, CURRENT_DATE, 5, NULL),
	...
	('F-PARIS006','UniversitÈ Pierre et Marie Curie, Paris 6- Main Site', 'georgua.en', 2, TRUE, CURRENT_DATE, 10, NULL),
...
INSERT INTO ArgomentoTesi(Id, Nome, NomeUniversita, Triennale, Magistrale, Stato) VALUES
	(DEFAULT, 'Counting up to ten', 'Universit‡†degli Studi di Padova', TRUE, TRUE, 'NOT VERIFIED');
...
INSERT INTO ValutazioneUniversita VALUES
	('JuventinoDOC','Ecole normale sup√©rieure',5,4,3,4,CURRENT_DATE,NULL),
