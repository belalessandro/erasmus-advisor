...
/**
* Bean which represents the "Insegnamento" table in the database 
* 
* @author Alessandro
* @version 1.0
*  
*/
public class InsegnamentoBean implements Serializable {
	
	private static final long serialVersionUID = -4250470171725790549L;
